      ...
      <div className="navbar container mx-auto ">
        <div className="navbar-start">
          <div className="dropdown">
            <div tabIndex={0} role="button" className="text-white font-xl btn bg-transparent border-0 lg:hidden">
              <svg
            ...
            <ul
              tabIndex={0}
              className="menu text-lg menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-[#00374D] rounded-box w-52"
            >
              {Link}
            </ul>
          </div>
