...
const EstateSection = ({ hospital }) => {
  const { id, property_name, rating, location, image, additional_info } =
    hospital;
  return (
        ...
        <div>
          <div className="relative flex items-end overflow-hidden rounded-xl">
            <img
              src={image}
              alt="Hotel Photo"
              className="w-[370px] h-[245px] rounded-xl"
            />
          ...
          <div className="mt-1 p-2">
            ...
            <div className="mt-3 flex items-end justify-between">
              ...
              <div className="group inline-flex rounded-xl ">
                <Link to={`/estate/${id}`}>
                  <a className="relative inline-flex items-center justify-center px-5 py-3 overflow-hidden font-medium tracking-tighter text-white bg-sky-300 rounded-lg group">
